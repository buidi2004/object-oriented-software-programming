      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-md shadow-sm border border-slate-200 overflow-hidden">
          <div className="bg-gradient-to-r from-indigo-600 to-purple-700 p-8 text-slate-900">
            ...
            <p className="text-slate-700">Khởi tạo nhanh chóng, sẵn sàng sử dụng chỉ sau vài cú click chuột.</p>
          </div>
          ...
          <div className="p-8 space-y-12">
            ...
            <section>
              <div className="flex items-center gap-3 mb-4 text-slate-900">
                <div className="p-2 bg-indigo-100 rounded-sm text-[#1F1F1F]"><ShoppingCart className="w-6 h-6" /></div>
            ...
            <section>
              <div className="flex items-center gap-3 mb-4 text-slate-900">
                <div className="p-2 bg-pink-100 rounded-sm text-pink-600"><UserCheck className="w-6 h-6" /></div>
            ...
            <section>
              <div className="flex items-center gap-3 mb-4 text-slate-900">
                <div className="p-2 bg-emerald-100 rounded-sm text-emerald-600"><ShieldCheck className="w-6 h-6" /></div>
              ...
              <div className="bg-emerald-50 rounded p-5 border border-emerald-200">
