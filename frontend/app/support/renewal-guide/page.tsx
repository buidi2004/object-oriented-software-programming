          ...
          <div className="p-8 space-y-12">
            ...
            <section>
              <div className="flex items-center gap-3 mb-4 text-slate-900">
                <div className="p-2 bg-emerald-100 rounded-sm text-emerald-600"><RefreshCw className="w-6 h-6" /></div>
            ...
            <section>
              <div className="flex items-center gap-3 mb-4 text-slate-900">
                <div className="p-2 bg-blue-100 rounded-sm text-[#1F1F1F]"><Clock className="w-6 h-6" /></div>
            ...
            <section>
              <div className="flex items-center gap-3 mb-4 text-slate-900">
                <div className="p-2 bg-amber-100 rounded-sm text-amber-600"><AlertTriangle className="w-6 h-6" /></div>
              ...
              <div className="bg-amber-50 rounded p-5 border border-amber-200">
