      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-md shadow-sm border border-slate-200 overflow-hidden">
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-8 text-slate-900">
            ...
            <p className="text-slate-700">Đa dạng, tiện lợi và an toàn cho mọi giao dịch của bạn.</p>
          </div>
          ...
          <div className="p-8 space-y-12">
            ...
            <section>
              <div className="flex items-center gap-3 mb-4 text-slate-900">
                <div className="p-2 bg-blue-100 rounded-sm text-[#1F1F1F]"><QrCode className="w-6 h-6" /></div>
            ...
            <section>
              <div className="flex items-center gap-3 mb-4 text-slate-900">
                <div className="p-2 bg-emerald-100 rounded-sm text-emerald-600"><Wallet className="w-6 h-6" /></div>
            ...
            <section>
              <div className="flex items-center gap-3 mb-4 text-slate-900">
                <div className="p-2 bg-amber-100 rounded-sm text-amber-600"><CreditCard className="w-6 h-6" /></div>
            ...
            <section>
              <div className="flex items-center gap-3 mb-4 text-slate-900">
                <div className="p-2 bg-purple-100 rounded-sm text-purple-600"><Building className="w-6 h-6" /></div>
