  ...
  const apps = [
    {
      ...
      name: 'WordPress',
      category: 'cms',
      description: 'Nền tảng CMS phổ biến nhất thế giới. Cấu hình nhẹ nhàng với 256MB RAM / 0.5 vCPU.',
      tag: 'Phổ biến',
      version: '6.4',
      icon: '🌐',
    ...
    },
    {
      ...
      name: 'Ghost CMS',
      category: 'cms',
      description: 'Nền tảng blog hiện đại, cực nhanh và tối ưu SEO. Yêu cầu 256MB RAM / 0.5 vCPU.',
      tag: 'Blogging',
      version: '5.x',
      icon: '👻',
    ...
    },
    {
      ...
      name: 'Nextcloud Hub',
      category: 'tools',
      description: 'Đám mây lưu trữ dữ liệu cá nhân. Cấu hình cơ bản 256MB RAM / 0.5 vCPU.',
      tag: 'Lưu trữ riêng',
      version: '28.0',
      icon: '☁️',
    ...
    },
    {
      ...
      name: 'n8n Automation',
      category: 'tools',
      description: 'Công cụ tự động hóa quy trình làm việc mã nguồn mở. Yêu cầu 256MB RAM / 0.5 vCPU.',
      tag: 'Tự động hóa',
      version: '1.29',
      icon: '🔄',
    ...
    },
    {
      ...
      name: 'Adminer',
      category: 'dev',
      description: 'Công cụ quản lý cơ sở dữ liệu siêu nhẹ qua giao diện Web. Chạy trên 256MB RAM / 0.5 vCPU.',
      tag: 'Database',
      version: '4.8',
      icon: '🗄️',
