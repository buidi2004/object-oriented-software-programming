  ...
  return (
    <div className="min-h-screen bg-slate-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button 
              ...
              disabled={saving}
              className="px-5 py-2 rounded bg-blue-600 text-white font-semibold text-sm hover:bg-blue-700 transition-colors flex items-center gap-2 shadow-sm disabled:opacity-50"
            >
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        {saved && (
          <div className="mb-6 p-4 rounded bg-emerald-50 border border-emerald-200 text-emerald-800 text-sm flex items-center gap-2 animate-in fade-in duration-200">
                ...
                {showAddCustom && (
                  <form onSubmit={handleAddCustomSetting} className="p-4 mb-6 rounded bg-slate-50 border border-slate-200 space-y-3">
                    ...
                    <div className="flex justify-end gap-2 pt-2">
                      ...
                      <button 
                        type="submit" 
                        className="px-4 py-1.5 rounded-sm bg-blue-600 text-white text-xs font-bold hover:bg-blue-700"
                      >
                        Lưu Key Mới
                      </button>
                    </div>
