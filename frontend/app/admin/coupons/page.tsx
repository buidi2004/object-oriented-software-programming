            ...
            <div key={coupon.id} className={`bg-white rounded-xl p-5 border transition-colors ${coupon.isActive ? 'border-slate-200' : 'border-slate-200 opacity-75'}`}>
              ...
              <div className="space-y-2 text-sm mb-4">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">{coupon.minOrderValue.toLocaleString('vi-VN')} đ</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">{new Date(coupon.startDate).toLocaleDateString('vi-VN')} - {new Date(coupon.endDate).toLocaleDateString('vi-VN')}</span>
                </div>
              </div>
