    ...
    <div className="min-h-screen bg-slate-50">
      <header className="bg-white border-b border-slate-200">
        <div className="max-w-3xl mx-auto px-4 h-16 flex items-center gap-4">
          <Link href="/admin/users" className="p-2 rounded-sm hover:bg-slate-100">
      ...
      <main className="max-w-3xl mx-auto px-4 py-8">
        <div className="bg-white rounded-md border border-slate-200 p-6 shadow-sm space-y-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600 flex items-center gap-1"><Mail className="w-4 h-4" /> {user.email}</p>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-4 pt-4 border-t border-slate-100">
            <div>
              <p className="text-xs text-slate-600 uppercase font-semibold">Vai trò</p>
              <p className="flex items-center gap-1 mt-1 font-semibold"><Shield className="w-4 h-4 text-[#1F1F1F]" /> {user.roleName}</p>
            </div>
            <div>
              <p className="text-xs text-slate-600 uppercase font-semibold">Trạng thái</p>
            ...
            <div>
              <p className="text-xs text-slate-600 uppercase font-semibold">User ID</p>
