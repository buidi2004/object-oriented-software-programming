      ...
      <div className="max-w-6xl mx-auto">
          ...
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <input
                ...
                className="pl-9 pr-4 py-2 rounded bg-white border border-slate-200 text-xs text-slate-900 focus:outline-none focus:ring-2 focus:ring-purple-500 shadow-sm"
              />
            </div>
            <button
        ...
        {isCreating && (
          <div className="fixed inset-0 bg-white/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-lg p-6 max-w-md w-full border border-slate-200 shadow-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {filtered.map((org) => (
            <div key={org.id} className="bg-white rounded-md p-5 border border-slate-200 shadow-sm hover:shadow-md transition-all">
