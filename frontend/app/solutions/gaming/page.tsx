...
import { Gamepad2, Compass, Zap } from 'lucide-react';
...
export default function GamingSolutionPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-slate-300 overflow-hidden selection:bg-purple-500 selection:text-white">
      {/* HERO */}
      <section className="relative h-[80vh] flex items-center justify-center text-center overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-purple-900/30 to-[#0a0a0a]"></div>
        <div className="relative z-10 max-w-4xl mx-auto px-4">
          <ScrollReveal animation="zoom-in">
            <Gamepad2 className="w-20 h-20 mx-auto text-purple-500 mb-6 drop-shadow-[0_0_20px_rgba(var(--color-purple-500),0.8)]" />
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 h-[1200px] overflow-hidden relative">
           ...
           <motion.div style={{ y: y1 }} className="space-y-8 pt-20">
              ...
              <div className="rounded-3xl overflow-hidden bg-purple-900/20 border border-purple-900/50 p-8">
                 <div className="text-6xl font-black text-purple-500 mb-4">01</div>
           ...
           <motion.div style={{ y: y2 }} className="space-y-8 pb-20 -mt-64">
              <div className="rounded-3xl overflow-hidden bg-purple-500 p-10 text-white shadow-[0_0_40px_rgba(var(--color-purple-500),0.3)]">
                 <Compass className="w-12 h-12 mb-6 opacity-80" />
                 <h3 className="text-3xl font-black mb-4">Khám Phá Mới</h3>
                 <p className="text-purple-100 text-lg">Giao diện này rất thích hợp cho những nội dung mang tính sáng tạo, gaming, hoặc showcase sản phẩm.</p>
              </div>
              <div className="rounded-3xl overflow-hidden bg-slate-900 border border-slate-800 p-8">
              ...
              <div className="rounded-3xl overflow-hidden bg-slate-900 border border-slate-800 p-8">
                 ...
                 <h3 className="text-2xl font-bold text-purple-500 mb-3">Hiệu Suất Cao</h3>
      ...
      {/* CTA */}
      <section className="py-32 bg-purple-950 text-center relative z-20">
         <div className="max-w-3xl mx-auto px-4">
            <h2 className="text-4xl font-black text-white mb-8">Bắt Đầu Trải Nghiệm Game Studio</h2>
            <Link href="/contact" className="inline-block px-12 py-5 bg-purple-500 text-white font-bold rounded-full hover:bg-purple-400 transition-colors shadow-[0_0_20px_rgba(var(--color-purple-500),0.5)]">
               Khởi Tạo Ngay
            </Link>
         </div>
      </section>
