...
import { Server, Target, LayoutDashboard, Fingerprint, ArrowRight } from 'lucide-react';
        ...
        <ScrollReveal animation="fade">
          ...
          <h1 className="text-4xl sm:text-6xl font-black text-slate-900 mb-6">
            ...
            <span className="text-slate-600">
              <TypewriterText text="Giải pháp Enterprise" speed={50} delay={0.2} />
            </span>
          </h1>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <ScrollReveal animation="slide-left">
              ...
              <p className="text-slate-600 text-lg leading-relaxed mb-6">
                Mỗi thao tác xử lý trong <span className="font-bold">Giải pháp Enterprise</span> đều được ghi nhận với độ trễ bằng 0. Hoàn hảo cho các tác vụ mang tính chất thời gian thực.
              </p>
              <div className="font-mono text-slate-600 bg-slate-50 p-4 rounded-lg border border-slate-100">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <ScrollReveal animation="slide-right" className="order-2 md:order-1">
              ...
              <p className="text-slate-400 text-lg leading-relaxed mb-6">
                Được bảo vệ bởi 2 lớp mã hóa vật lý và phần mềm. Dữ liệu của hệ thống <span className="font-bold">Giải pháp Enterprise</span> được an toàn trước mọi rủi ro xâm nhập.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <ScrollReveal animation="slide-up" delay={0.2}>
              ...
              <Link href="/contact" className="inline-flex items-center gap-2 px-8 py-4 bg-slate-600 text-white font-bold rounded-xl shadow-lg hover:bg-slate-700 transition-all">
          ...
          <Phase5Extensions themeColor="slate" />
