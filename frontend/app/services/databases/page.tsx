...
export default function DatabasesServicePage() {
  ...
  useEffect(() => {
    import('@/src/lib/api').then(({ api }) => {
      api.get('/categories/managed-database/plans').then(res => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 selection:bg-sky-500 selection:text-white font-sans">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 p-3.5 mb-10 rounded-2xl bg-[#0d1424] border border-slate-200 text-xs font-mono">
            <div className="flex items-center gap-3">
              ...
              <span className="text-slate-700 hidden sm:inline">
                DATACENTER: <span className="text-slate-900 font-bold">Tier-III Viettel IDC (Hà Nội & TP.HCM)</span>
              </span>
            </div>

            <div className="flex items-center gap-4 text-slate-600">
              <span>SLA: <strong className="text-slate-900 font-mono">99.99%</strong></span>
              ...
              <div className="rounded-2xl bg-[#0b1320] border border-slate-200 p-6 shadow-2xl space-y-5">
                <div className="flex items-center justify-between pb-3 border-b border-slate-200">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-mono text-slate-600 ml-2">db-cluster-telemetry.sen</span>
                  </div>
          ...
          <div className="p-8 rounded-3xl bg-white border border-slate-200 relative overflow-hidden">
            ...
            <div className="mb-8 p-4 rounded-xl bg-[#070c16] border border-slate-200 flex flex-wrap items-center justify-between gap-4 font-mono text-xs">
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-slate-600">TRANSACTION LOSS:</span>
              ...
              <div className={`p-6 rounded-2xl border transition-all ${
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-mono font-bold text-slate-900 text-sm">Node 01: HN-DC1</span>
                  </div>
              ...
              <div className="p-6 rounded-2xl bg-[#0f1728] border border-slate-200">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-mono font-bold text-slate-900 text-sm">Node 03: DNG-DC3</span>
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="p-4 rounded-2xl bg-slate-100 border border-slate-200 mb-6 font-mono text-xs">
                  ...
                  <div className="space-y-2 text-slate-700">
                    <div className="p-2 rounded bg-white border border-slate-200 flex items-center justify-between">
                      <span className="text-slate-600">1. Node 1 Heartbeat Lost</span>
                    ...
                    <div className="text-center text-slate-600">↓</div>
                    <div className="p-2 rounded bg-white border border-slate-200 flex items-center justify-between">
                      <span className="text-slate-600">3. Node 2 Promoted</span>
                      <span className="text-emerald-400 font-bold">Virtual IP Re-routed</span>
                    </div>
                  </div>
                </div>

                <h3 className="text-lg font-bold text-slate-900 mb-2">Cụm High Availability 99.99%</h3>
            ...
            <div className="p-6 rounded-3xl bg-white border border-slate-200 flex flex-col justify-between space-y-6">
              <div>
                ...
                <div className="p-4 rounded-2xl bg-slate-100 border border-slate-200 mb-6 font-mono text-xs">
                  ...
                  <div className="relative py-3 space-y-3">
                    <div className="flex items-center justify-between text-[11px]">
                      <span className="text-slate-600">00:00 Base Snapshot</span>
                ...
                <h3 className="text-lg font-bold text-slate-900 mb-2">Khôi Phục Tới Từng Giây (PITR)</h3>
                <p className="text-xs text-slate-600 leading-relaxed">
            ...
            <div className="p-6 rounded-3xl bg-white border border-slate-200 flex flex-col justify-between space-y-6">
              <div>
                ...
                <div className="p-4 rounded-2xl bg-slate-100 border border-slate-200 mb-6 font-mono text-xs">
                  ...
                  <div className="space-y-2 text-slate-700 text-[11px]">
                    <div className="flex items-center justify-between p-1.5 rounded bg-white border border-slate-200">
                      ...
                      <span className="text-slate-600">TLS 1.3 Encrypted</span>
                    </div>
                    <div className="flex items-center justify-between p-1.5 rounded bg-white border border-slate-200">
                ...
                <h3 className="text-lg font-bold text-slate-900 mb-2">Bảo Mật Zero-Trust &amp; Mạng Riêng</h3>
                <p className="text-xs text-slate-600 leading-relaxed">
      ...
      <section id="pricing-matrix" className="py-24 bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <table className="w-full text-left text-xs font-mono">
                ...
                <tbody className="divide-y divide-slate-800/60 text-slate-700">
                  <tr className="hover:bg-slate-900/40">
                    <td className="p-4 font-bold text-slate-600">CPU Dedicated</td>
                    {plans.map((p) => (
                      <td key={p.id} className="p-4 border-l border-slate-200/60 text-slate-900 font-bold">{p.cpu}</td>
                    ))}
                  </tr>
                  <tr className="hover:bg-slate-900/40">
                    <td className="p-4 font-bold text-slate-600">RAM ECC</td>
                    {plans.map((p) => (
                      <td key={p.id} className="p-4 border-l border-slate-200/60 text-slate-900 font-bold">{p.ram}</td>
                    ))}
                  </tr>
                  <tr className="hover:bg-slate-900/40">
                    <td className="p-4 font-bold text-slate-600">Dung Lượng NVMe RAID-10</td>
                    {plans.map((p) => (
                  ...
                  <tr className="hover:bg-slate-900/40">
                    <td className="p-4 font-bold text-slate-600">Max Concurrent Connections</td>
                    {plans.map((p) => (
                      <td key={p.id} className="p-4 border-l border-slate-200/60 text-slate-900 font-bold">{p.maxConn} kết nối</td>
                    ))}
                  </tr>
                  <tr className="hover:bg-slate-900/40">
                    <td className="p-4 font-bold text-slate-600">Kiến Trúc High Availability</td>
                    {plans.map((p) => (
                      <td key={p.id} className="p-4 border-l border-slate-200/60 text-slate-800">{p.haType}</td>
                    ))}
                  </tr>
                  <tr className="hover:bg-slate-900/40">
                    <td className="p-4 font-bold text-slate-600">Khôi Phục Point-in-Time (PITR)</td>
                    {plans.map((p) => (
                      <td key={p.id} className="p-4 border-l border-slate-200/60 text-slate-800">{p.pitr}</td>
                    ))}
                  </tr>
                  <tr className="hover:bg-slate-900/40">
                    <td className="p-4 font-bold text-slate-600">Throughput Benchmark (Đo lường)</td>
                    {plans.map((p) => (
      ...
      <section className="py-20 bg-slate-50 border-b border-slate-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900">Câu Hỏi Thường Gặp Của Kỹ Sư &amp; DBA</h2>
            <p className="text-slate-600 text-xs sm:text-sm mt-2 font-mono">SEN CLOUDHOST MANAGED DATABASE FAQ</p>
          </div>
