  ...
  const plans = [
    {
      ...
      features: [
        ...
        'Tự động sao lưu hàng ngày (7 ngày lưu trữ)',
        'SSL Encrypted Connection',
        'Giám sát hiệu năng IOPS & Connection',
        'Khôi phục dữ liệu theo thời gian (PITR)',
        'Mở rộng tài nguyên không cần tắt máy',
      ],
      badge: null,
      popular: false,
    },
    {
      id: 'db-standard',
      name: 'DB Production Standard',
      tagline: 'Phổ biến cho ứng dụng Web, E-commerce, SaaS',
      monthlyPrice: 599000,
      ...
      features: [
        'Cụm High Availability (Primary - Standby Replica)',
        'Tự động chuyển đổi dự phòng (Auto Failover < 10s)',
        'Tự động sao lưu hàng ngày (30 ngày lưu trữ)',
        'Read Replica tăng tốc độ đọc dữ liệu',
        'Tối ưu chỉ mục và phát hiện Slow Query thông minh',
        'Hỗ trợ kỹ thuật 24/7 chuyên sâu DBA',
      ],
      badge: 'Khuyên dùng',
      popular: true,
    },
    {
      id: 'db-enterprise',
      name: 'DB High Memory Pro',
      tagline: 'Dành cho hệ thống tải cao, Big Data & Analytics',
      ...
      features: [
        'Tối ưu In-Memory Cache hiệu năng cực đại',
        'Multi-AZ Replication chống gián đoạn',
        'Dedicated IOPS lên tới 10,000 IOPS',
        'Không giới hạn số lượng kết nối Connection Pool',
        'Audit Logging bảo mật tuân thủ ISO/SOC2',
