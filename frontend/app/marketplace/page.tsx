        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="max-w-xl mx-auto relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3.5 rounded-md bg-white/90 border border-slate-300 text-slate-900 placeholder-slate-400 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500 shadow-xl"
            />
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredProducts.map((p) => (
            <div
              key={p.id}
              className="bg-white rounded-lg p-6 border border-slate-200 shadow-sm hover:shadow-xl hover:border-violet-300 transition-all duration-300 flex flex-col justify-between group"
            >
              <div>
                <div className="flex items-center justify-between mb-4">
                  <div className="text-3xl p-3 rounded-md bg-violet-50 text-violet-600">
                    {p.icon}
                  </div>
              ...
              <div className="pt-4 border-t border-slate-100">
                <div className="flex items-baseline justify-between mb-4">
                  <div>
                    ...
                    <span className="text-xs text-slate-600 font-medium ml-1">đ/tháng</span>
                  </div>
                ...
                <button
                  onClick={() => handleBuy(p)}
                  className="w-full py-3 rounded bg-white group-hover:bg-violet-600 text-slate-900 text-xs font-bold transition-all flex items-center justify-center gap-1.5 shadow-md"
                >
