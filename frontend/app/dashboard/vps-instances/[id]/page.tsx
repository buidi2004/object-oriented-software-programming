...
import { 
  ...
  Eye, EyeOff, Moon, Layers, BarChart3, Settings, Sliders, FileText, ChevronDown, ChevronLeft, Send
} from 'lucide-react';
        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
          <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#94a3b8] mt-1">VPS Giá Rẻ</p>
            </div>
        ...
        <div className="p-6 border-b border-slate-700">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <h3 className="text-2xl font-bold text-white tracking-tight font-sans">{vps.planName || 'Cheap 4'}</h3>
            ...
            <div className="flex items-center gap-3">
              ...
              <button onClick={() => fetchStats()} className="p-2 text-slate-400 hover:text-white rounded-sm hover:bg-white/5 transition-colors">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-[#101828] p-5 rounded border border-slate-700 shadow-sm space-y-4">
                <div className="flex justify-between items-center text-xs">
                  ...
                  <span className="font-mono text-slate-400 font-bold">{stats?.diskUsedGb ?? 14.81} / {vps.diskGb || 30} GB</span>
                </div>
            ...
            <div className="bg-[#050505] rounded border border-slate-700 overflow-hidden shadow-inner mt-6">
              <div className="flex items-center justify-between px-4 py-2.5 bg-[#101828] border-b border-slate-700 text-xs">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button onClick={() => setIsTerminalOpen(true)} className="text-slate-400 hover:text-white text-xs font-mono ml-2">
                    [Phóng to]
                  </button>
                </div>
              </div>
              ...
              <div className="p-2.5 bg-[#101828] border-t border-slate-700 flex items-center gap-2">
                ...
                <input
                  ...
                  disabled={vps?.status !== 'Running' || isExecRunning}
