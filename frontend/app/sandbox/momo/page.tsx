  ...
  if (status === 'success') {
    return (
      <PaymentSuccessReceipt
        orderId={orderId}
        amount={amount}
        paymentMethod="Ví MoMo (MoMo Pay)"
          ...
          <div className="lg:col-span-5 flex flex-col items-center justify-center bg-slate-50 p-6 rounded-lg border border-slate-200/80 text-center">
            {isFakeAccount ? (
              ...
              <div className="bg-white p-3 rounded-md shadow-md border border-slate-200 relative group mb-4">
                ...
                />
                <div className="absolute inset-0 bg-[#A50064]/10 rounded-md opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center pointer-events-none">
          ...
          <div className="lg:col-span-7 space-y-4">
              ...
              <div className="flex items-center justify-between py-2 border-b border-slate-200 text-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="p-1.5 rounded-sm bg-[#fce4ec] text-[#1F1F1F] hover:bg-[#fce4ec] transition-colors"
                    title="Sao chép"
                  >
            ...
            <div className="pt-2 space-y-3">
              <div className="w-full py-4 rounded-md bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 text-center">
                ...
                <p className="text-xs text-amber-600 mt-1">Sau khi thanh toán qua MoMo, dịch vụ sẽ được kích hoạt tự động trong vài giây</p>
              </div>
