    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
      <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-slate-200/80 bg-white aspect-[21/9] sm:aspect-[24/8] group">
        ...
        <div className="absolute inset-0 p-6 sm:p-10 lg:p-12 flex flex-col justify-center max-w-xl z-10">
          ...
          <h2 className="text-xl sm:text-3xl lg:text-4xl font-black text-slate-900 leading-tight mb-2 tracking-tight">
            Nâng Tầm Hạ Tầng <br className="hidden sm:block" />
            <span className="bg-gradient-to-r from-cyan-400 via-blue-400 to-indigo-300 bg-clip-text text-transparent">
              Giảm Đến 50% Năm Đầu
            </span>
          </h2>
          <p className="text-xs sm:text-sm text-slate-700 line-clamp-2 mb-4 font-medium">
        ...
        {banners.length > 1 && (
          <>
            <button
              onClick={handlePrev}
              className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-slate-50/40 hover:bg-slate-950/80 text-slate-900 backdrop-blur-md flex items-center justify-center transition-all opacity-0 group-hover:opacity-100 z-20"
            ...
            <button
              onClick={handleNext}
              className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-slate-50/40 hover:bg-slate-950/80 text-slate-900 backdrop-blur-md flex items-center justify-center transition-all opacity-0 group-hover:opacity-100 z-20"
