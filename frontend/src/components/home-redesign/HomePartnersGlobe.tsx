    ...
    <section className="py-20 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-10 items-center">
          ...
          {/* Partners Left */}
          <div>
            <h3 className="text-2xl font-black text-slate-900 mb-8 text-left">Đối tác</h3>
          ...
          <div className="flex justify-center relative py-10 md:py-0">
            <div className="absolute inset-0 bg-blue-50/50 rounded-full blur-3xl" />
            <div className="w-64 h-64 sm:w-72 sm:h-72 rounded-full shadow-[0_0_50px_rgba(37,99,235,0.2)] flex items-center justify-center relative z-10">
              <img 
          ...
          {/* Customers Right */}
          <div>
            <h3 className="text-2xl font-black text-slate-900 mb-8 text-right">Khách hàng</h3>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="h-16 bg-blue-50 border border-blue-100 rounded-xl flex items-center justify-center text-sm font-black text-blue-600 shadow-xs cursor-pointer hover:scale-105 transition-transform">
                25,000+
              </div>
            </div>
          </div>
