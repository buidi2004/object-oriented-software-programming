...
const VPS_CONTENT: ServicePageContent = {
  ...
  deepFeatures: [
    ...
    },
    {
      ...
      bullets: [
        ...
        'Auto-backup hàng ngày (add-on từ 50.000đ/tháng)',
  ...
  addons: [
    { name: 'Auto Backup Daily', price: '50.000 đ/tháng', description: 'Snapshot tự động hàng ngày, giữ 14 bản gần nhất' },
    { name: 'Dedicated IPv4', price: '100.000 đ/tháng', description: 'IP tĩnh riêng, không chia sẻ NAT' },
    { name: 'GPU RTX A4000', price: '2.500.000 đ/tháng', description: '16GB VRAM cho AI inference / rendering' },
    { name: 'Managed Service', price: '500.000 đ/tháng', description: 'Admin cài đặt, patch bảo mật, monitoring 24/7' },
    { name: 'Windows Server License', price: '350.000 đ/tháng', description: 'Windows Server 2022 Standard genuine license' },
    { name: 'Extra 100GB NVMe', price: '120.000 đ/tháng', description: 'Mở rộng dung lượng SSD không cần migrate' },
  ],
  testimonials: [
  ...
  extendedFaqs: [
    ...
    { q: 'VPS có bị giới hạn băng thông quốc tế không?', a: 'Băng thong trong nước không giới hạn. Quốc tế 10TB/tháng, mua thêm 50.000đ/100GB.' },
...
const HOSTING_CONTENT: ServicePageContent = {
  ...
  promotions: [
    {
      ...
      description: 'Gói Business Pro chỉ còn 801.000đ/năm thay vì 1.068.000đ.',
      discount: '-25%',
      code: 'HOST25',
  ...
  addons: [
    { name: 'Dedicated IP', price: '150.000 đ/tháng', description: 'IP riêng cho SSL EV hoặc email reputation' },
    { name: 'Wildcard SSL', price: '890.000 đ/năm', description: 'Bảo mật tất cả subdomain (*.domain.com)' },
    { name: 'SiteLock Premium', price: '120.000 đ/tháng', description: 'Quét malware + blacklist monitoring' },
    { name: 'Priority Support', price: '200.000 đ/tháng', description: 'Hotline ưu tiên, response < 10 phút' },
    { name: 'Extra 10GB NVMe', price: '80.000 đ/tháng', description: 'Mở rộng dung lượng hosting' },
    { name: 'Reseller WHM', price: '500.000 đ/tháng', description: 'Tạo hosting con cho khách hàng của bạn' },
  ],
  testimonials: [
...
const DOMAIN_CONTENT: ServicePageContent = {
  ...
  promotions: [
    {
      badge: 'Hot Deal',
      title: '.com chỉ 290.000đ/năm đầu',
      description: 'Giảm từ 350.000đ, áp dụng cho đăng ký mới và transfer.',
      discount: '-17%',
      validUntil: '31/12/2026',
    },
    {
  ...
  addons: [
    { name: 'Premium DNS', price: '50.000 đ/tháng', description: 'GeoDNS, failover, TTL thấp 60s' },
    { name: 'Domain Monitoring', price: '30.000 đ/tháng/domain', description: 'Theo dõi expiry, DNS hijack, blacklist' },
    ...
    { name: 'Email @domain', price: 'Từ 50.000 đ/tháng', description: 'Email hosting 5GB/account' },
    { name: 'Privacy Plus (.vn)', price: '100.000 đ/năm', description: 'WHOIS privacy cho tên miền .vn' },
  ],
  testimonials: [
