...
public class RejectAffiliateCommandHandler : IRequestHandler<RejectAffiliateCommand>
{
    private readonly IUnitOfWork _uow;
    private readonly IRepository<AffiliateApplication> _repo;

    public RejectAffiliateCommandHandler(IUnitOfWork uow, IRepository<AffiliateApplication> repo)
    {
        _uow = uow;
        _repo = repo;
    }

    public async Task Handle(RejectAffiliateCommand request, CancellationToken ct)
    {
